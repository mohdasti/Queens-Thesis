...
## Data analysis
Statistical analyses (analysis of variance [ANOVA] and Bayesian framework analysis and other correlational studies and electrophysiological measures) were carried out using the R software package (Version 1.1.463; R Core Team).
# References
